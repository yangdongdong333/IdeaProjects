...
public class MyIntercepter implements HandlerInterceptor
{
    ...
    {
        System.out.println("拦截器的MyIntercepter的preHandler");
        //给浏览器一个返回结果
       // request.getRequestDispatcher("tips.jsp").forward(request,response); //执行转发时，不能跟视图解析器一起使用，要当没有视图解析器，所以此时的地址是webapp下面
        return true;
    }
